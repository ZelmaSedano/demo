...
### Personal Statement 
Zelma is an aspiring Back-End Web Developer who has set her eye on attending Ada Developer's Academy in Seattle.  She has previously worked as a Full-Charge Bookkeeper for two companies, then used a cash windfall to travel the world after moving to Norway in 2016.  Since 2016 she has taught herself HTML and CSS, and once she decided she was interested in getting into a coding bootcamp she has taught herself algorithmic JavaScript and Ruby.  Additionally, she has learned Python and the Pandas library to analyze the data set that is apart of the application process.  
...
### Skills 
+_Coding Languages_: HTML5, CSS, JavaScript, Ruby 
